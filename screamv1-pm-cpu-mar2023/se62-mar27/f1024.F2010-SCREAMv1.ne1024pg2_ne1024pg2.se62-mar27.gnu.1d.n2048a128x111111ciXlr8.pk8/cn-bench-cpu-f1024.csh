...
#set cn="$wdir/f1024.$compset.$res.$repo.$compiler.36s.n1536a128x111111ciXlr8.pk8.blob"

#set cn="$wdir/f1024.$compset.$res.$repo.$compiler.36s.n2048a128x111111ciXlr8.pk8"
#set cn="$wdir/f1024.$compset.$res.$repo.$compiler.36s.n2048a128x111111ciXlr4.pk8.blob"
