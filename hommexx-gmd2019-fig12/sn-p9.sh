...
#BSUB -e sn-p9.err
#BSUB -J sn-p9
. /ascldap/users/ambradl/climate/source-waterman-v100.sh
mkdir -p sn-p9-run;
cd sn-p9-run

echo "AMB> p9 qsize 40 ne  2 nrank 24 nthr   2 nmax  8001"
...
mpirun --bind-to core --map-by ppr:24:node:pe=1 /ascldap/users/ambradl/climate/hxx/build-p9/test_execs/prtcB_c/prtcB_c < input.nl &> /dev/null
head -n 50 HommeTime*

echo "AMB> p9 qsize 40 ne  3 nrank 40 nthr   2 nmax  3558"
sed -e s/NE/3/ -e s/QSIZE/40/ -e s/NMAX/3558/ -e s/TSTEP/1/ ../xx-template.nl > input.nl
export KMP_AFFINITY=balanced,granularity=fine
export OMP_NUM_THREADS=2
mpirun --bind-to core --map-by ppr:40:node:pe=1 /ascldap/users/ambradl/climate/hxx/build-p9/test_execs/prtcB_c/prtcB_c < input.nl &> /dev/null
head -n 50 HommeTime*

echo "AMB> p9 qsize 40 ne  4 nrank 40 nthr   2 nmax  2001"
...
echo "AMB> p9 qsize 40 ne  5 nrank 40 nthr   2 nmax  1281"
...
echo "AMB> p9 qsize 40 ne  6 nrank 40 nthr   2 nmax   891"
...
echo "AMB> p9 qsize 40 ne  7 nrank 40 nthr   2 nmax   654"
...
echo "AMB> p9 qsize 40 ne  8 nrank 40 nthr   2 nmax   501"
...
echo "AMB> p9 qsize 40 ne  9 nrank 40 nthr   2 nmax   396"
...
echo "AMB> p9 qsize 40 ne 10 nrank 40 nthr   2 nmax   321"
...
echo "AMB> p9 qsize 40 ne 11 nrank 40 nthr   2 nmax   267"
...
echo "AMB> p9 qsize 40 ne 16 nrank 40 nthr   2 nmax   126"
...
echo "AMB> p9 qsize 40 ne 20 nrank 40 nthr   2 nmax    81"
...
echo "AMB> p9 qsize 40 ne 24 nrank 40 nthr   2 nmax    57"
...
echo "AMB> p9 qsize 40 ne 32 nrank 40 nthr   2 nmax    33"
...
echo "AMB> p9 qsize  0 ne  2 nrank 24 nthr   2 nmax 40005"
...
echo "AMB> p9 qsize  0 ne  3 nrank 40 nthr   2 nmax 17790"
...
echo "AMB> p9 qsize  0 ne  4 nrank 40 nthr   2 nmax 10005"
...
echo "AMB> p9 qsize  0 ne  5 nrank 40 nthr   2 nmax  6405"
...
echo "AMB> p9 qsize  0 ne  6 nrank 40 nthr   2 nmax  4455"
...
echo "AMB> p9 qsize  0 ne  7 nrank 40 nthr   2 nmax  3270"
...
echo "AMB> p9 qsize  0 ne  8 nrank 40 nthr   2 nmax  2505"
...
echo "AMB> p9 qsize  0 ne  9 nrank 40 nthr   2 nmax  1980"
...
echo "AMB> p9 qsize  0 ne 10 nrank 40 nthr   2 nmax  1605"
...
echo "AMB> p9 qsize  0 ne 11 nrank 40 nthr   2 nmax  1335"
...
echo "AMB> p9 qsize  0 ne 16 nrank 40 nthr   2 nmax   630"
...
echo "AMB> p9 qsize  0 ne 20 nrank 40 nthr   2 nmax   405"
...
echo "AMB> p9 qsize  0 ne 24 nrank 40 nthr   2 nmax   285"
...
echo "AMB> p9 qsize  0 ne 32 nrank 40 nthr   2 nmax   165"
